...
const Modal = ({ showModal, setShowModal, singerId }: ModalProps) => {
  ...
  useEffect(() => {
    dispatch(singerThunk.getOneSinger(singerId));
  });

  if (!singer) return <div>Not found singer</div>;
      ...
      >
        ...
        <Formik
          ...
          initialValues={{
            ...
            bio: singer.bio,
            story: singer.story,
            birthday: moment(singer.birthday).format("yyyy-MM-DD"),
            country: singer.country,
            debutYear: singer.debutYear,
            website: singer.website,
            facebook: singer.facebook,
            twitter: singer.twitter,
            instagram: singer.instagram,
            youtube: singer.youtube,
            tick: singer.tick,
            gender: singer.gender,
            imageUrl: singer.imageUrl,
            imageCover: singer.imageCover,
          }}
            ...
            dispatch(
              singerAdminThunk.updateSinger({
                ...
                data: {
                  ...
                  imageCover: imageCover || singer.imageCover,
                  imageUrl: imageUrl || singer.imageUrl,
                },
              })
            );
          }}
